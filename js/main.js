...
/***/ "./src/js/functions/scrollTriggers.js":
/*!********************************************!*\
  !*** ./src/js/functions/scrollTriggers.js ***!
  \********************************************/
...
/* harmony export */   friendsScrollTrigger: () => (/* binding */ friendsScrollTrigger),
/* harmony export */   inviteScrollTrigger: () => (/* binding */ inviteScrollTrigger),
/* harmony export */   timelineScrollTrigger: () => (/* binding */ timelineScrollTrigger)
/* harmony export */ });
...
const friendsScrollTrigger = () => {
  const mediaTrigger = (start, startScroll, end) => {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".friends", {
      scale: 0.3,
      opacity: 0,
      autoAlpha: 0,
      duration: 0.75,
...
const inviteScrollTrigger = () => {
  const inviteTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
...
const timelineScrollTrigger = () => {
  const mediaTriggerTitle = (start, startScroll, end) => {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".timeline__title", {
      scale: 0.3,
      opacity: 0,
      autoAlpha: 0,
      duration: 2,
  ...
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.matchMedia({
    "(min-width: 1025px)": () => {
      ...
      mediaTrigger("#timeline1", ".invite", "bottom+=20%", "top", "bottom+=20%");
      mediaTrigger("#timeline2", ".invite", "bottom+=40%", "top", "bottom+=40%");
      mediaTrigger("#timeline3", ".invite", "bottom+=60%", "top", "bottom+=60%");
      mediaTrigger("#timeline4", ".invite", "bottom+=80%", "top", "bottom+=80%");
    },
    "(min-width: 761px) and (max-width: 1024px)": () => {
      mediaTriggerTitle("center", "top", "center");
      mediaTrigger("#timeline1", ".invite", "bottom+=5%", "top", "bottom+=5%");
      mediaTrigger("#timeline2", ".invite", "bottom+=20%", "top", "bottom+=20%");
      mediaTrigger("#timeline3", ".invite", "bottom+=35%", "top", "bottom+=35%");
      mediaTrigger("#timeline4", ".invite", "bottom+=50%", "top", "bottom+=50%");
    },
    "(min-width: 581px) and (max-width: 760px)": () => {
      mediaTriggerTitle("center+=32%", "top", "center+=32%");
      mediaTrigger("#timeline1", ".invite", "bottom+=5", "top", "bottom+=5");
      mediaTrigger("#timeline2", ".invite", "bottom+=5%", "top", "bottom+=5%");
      mediaTrigger("#timeline3", ".invite", "bottom+=15%", "top", "bottom+=15%");
      mediaTrigger("#timeline4", ".invite", "bottom+=25%", "top", "bottom+=25%");
    },
    "(min-width: 320px) and (max-width: 580px)": () => {
      mediaTriggerTitle("center-=5%", "top", "center-=5%");
      mediaTrigger("#timeline1", ".invite", "center+=18%", "top", "center+=18%");
      mediaTrigger("#timeline2", ".invite", "center+=28%", "top", "center+=28%");
      mediaTrigger("#timeline3", ".invite", "center+=38%", "top", "center+=38%");
      mediaTrigger("#timeline4", ".invite", "center+=48%", "top", "center+=48%");
    }
  });
};
...
const timer = deadline => {
  ...
  const startTimer = () => {
    ...
    descSec.textContent = declOfNum(timer.seconds, ["секунда", "секунды", "секунд"]);
    descMin.textContent = declOfNum(timer.minutes, ["минута", "минуты", "минут"]);
...
/* harmony import */ var _functions_scrollTriggers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/scrollTriggers */ "./src/js/functions/scrollTriggers.js");
/* harmony import */ var _functions_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/timer */ "./src/js/functions/timer.js");



(0,_functions_scrollTriggers__WEBPACK_IMPORTED_MODULE_1__.inviteScrollTrigger)();
(0,_functions_scrollTriggers__WEBPACK_IMPORTED_MODULE_1__.friendsScrollTrigger)();
(0,_functions_scrollTriggers__WEBPACK_IMPORTED_MODULE_1__.timelineScrollTrigger)();
(0,_functions_timer__WEBPACK_IMPORTED_MODULE_2__.timer)("2024/09/01 15:30");
})();
